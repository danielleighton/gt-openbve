...
public class CompatibilityObjects
{
    ...
    internal static void LoadAutoGeneratedObjects(Node parent, string compatibilityFolder)
    {
        string limitPath = SimPaths.CombineDirectory(compatibilityFolder, "Limits");

        LimitGraphicsPath = SimPaths.CombineDirectory(limitPath, "Graphics");
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(limitPath, "limit_straight.csv"), System.Text.Encoding.UTF8, out LimitPostStraight);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(limitPath, "limit_left.csv"), System.Text.Encoding.UTF8, out LimitPostLeft);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(limitPath, "limit_right.csv"), System.Text.Encoding.UTF8, out LimitPostRight);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(limitPath, "limit_infinite.csv"), System.Text.Encoding.UTF8, out LimitPostInfinite);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(limitPath, "limit_1_digit.csv"), System.Text.Encoding.UTF8, out LimitOneDigit);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(limitPath, "limit_2_digits.csv"), System.Text.Encoding.UTF8, out LimitTwoDigits);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(limitPath, "limit_3_digits.csv"), System.Text.Encoding.UTF8, out LimitThreeDigits);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(compatibilityFolder, "stop.csv"), System.Text.Encoding.UTF8, out StopPost);

        string TransponderPath = SimPaths.CombineDirectory(compatibilityFolder, "Transponders");
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(TransponderPath, "s.csv"), System.Text.Encoding.UTF8, out TransponderS);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(TransponderPath, "sn.csv"), System.Text.Encoding.UTF8, out TransponderSN);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(TransponderPath, "falsestart.csv"), System.Text.Encoding.UTF8, out TransponderFalseStart);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(TransponderPath, "porigin.csv"), System.Text.Encoding.UTF8, out TransponderPOrigin);
        Plugin.CurrentHost.LoadObject(SimPaths.CombineFile(TransponderPath, "pstop.csv"), System.Text.Encoding.UTF8, out TransponderPStop);
    }
                        ...
                        foreach (XmlNode c in n.ChildNodes)
                        {
                            switch (c.Name.ToLowerInvariant())
                            {
                                case "name":
                                    ...
                                    break;
                                case "path":
                                    string f = SimPaths.CombineFile(d, c.InnerText.Trim());
