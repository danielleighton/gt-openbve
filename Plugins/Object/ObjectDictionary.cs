...
public class ObjectDictionary : Dictionary<int, UnifiedObject>
{
...
public class SignalDictionary : Dictionary<int, SignalObject>
{
...
public class PoleDictionary : Dictionary<int, ObjectDictionary>
{
