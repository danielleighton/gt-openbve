...
public static partial class SimPaths
{
    // --- read-only fields ---
    ...
    /// <summary>Combines a platform-specific absolute path with a platform-independent relative path that points to a System.IO.Directory.</summary>
    ...
    /// <returns>A platform-specific absolute path to the specified System.IO.Directory.</returns>
        ...
        for (int i = 0; i < parts.Length; i++)
        {
            if (parts[i].Length != 0)
            {
                ...
                if (IsAllPeriods(parts[i]))
                {
                     ...
                     * upper System.IO.Directory. A single period is the
                     * current System.IO.Directory. For each additional
                ...
                {
                    /*
                     * This part references a System.IO.Directory.
                     * */
                    if (absolute != null)
                    {
